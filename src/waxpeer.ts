...
export class Waxpeer {
    ...
    public buyItemWithId(
        ...
        return this.get(
            'buy-one-p2p',
            qs.stringify({ item_id, price, token, partner, project_id }),
        );
    }
     ...
     * }
     */
    public getSteamItems(game = 730, highest_offer: '0' | '1' = '0'): Promise<IGetSteamItems> {
     ...
     * }
     */
    public MerchantInventoryUpdate(
        steam_id: string,
        merchant: string,
    ): Promise<IMerchantInventoryUpate> {
    ...
    public MerchantListItemsSteam(
        ...
        return this.post(
            'merchant/list-items-steam',
            { items },
            qs.stringify({ merchant, steam_id }),
        );
    }
